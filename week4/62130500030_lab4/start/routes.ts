...
Route.get('/posts/:id', 'PostsController.show').where('id',/^[0-9]+$/).as('posts.show');
...
Route.post('/posts/:id/update','PostsController.update').as('posts.update');
Route.get('/posts/:id/delete','PostsController.destroy').as('posts.delete');
